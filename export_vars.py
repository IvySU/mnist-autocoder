...
with tf.Session() as sess:
    ...
    with open(file_path, "w") as handle:
        handle.write(mat2str('encoder_W0', eval_encoder_vars[0]))
        handle.write(vec2str('encoder_b0', eval_encoder_vars[1]))
        handle.write(mat2str('encoder_W1', eval_encoder_vars[2]))
        handle.write(vec2str('encoder_b1', eval_encoder_vars[3]))
        handle.write(mat2str('encoder_W2', eval_encoder_vars[4]))
        handle.write(vec2str('encoder_b2', eval_encoder_vars[5]))
        handle.write(mat2str('encoder_W3', eval_encoder_vars[6]))
        handle.write(vec2str('encoder_b3', eval_encoder_vars[7]))
        handle.write(mat2str('encoder_W4', eval_encoder_vars[8]))
        handle.write(vec2str('encoder_b4', eval_encoder_vars[9]))
        ...
        handle.write(mat2str('decoder_W4', eval_decoder_vars[8]))
        handle.write(vec2str('decoder_b4', eval_decoder_vars[9]))
